...
#define GPIO_PORT_LED1  LED1_GPIO_Port
#define GPIO_PIN_LED1	LED1_Pin

#define GPIO_PORT_LED2  LED2_GPIO_Port
#define GPIO_PIN_LED2	LED2_Pin

#define GPIO_PORT_LED3  LED2_GPIO_Port
#define GPIO_PIN_LED3	LED3_Pin
