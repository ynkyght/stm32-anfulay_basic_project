...
osThreadId SendTHandle;
osThreadId ReceiveTHandle;
...
void MX_FREERTOS_Init(void) {
  ...
  /* definition and creation of SendT */
  osThreadDef(SendT, SendTask, osPriorityIdle, 0, 128);
  SendTHandle = osThreadCreate(osThread(SendT), NULL);

  /* definition and creation of ReceiveT */
  osThreadDef(ReceiveT, ReceiveTask, osPriorityIdle, 0, 128);
  ReceiveTHandle = osThreadCreate(osThread(ReceiveT), NULL);
...
/**
* @brief Function implementing the SendT thread.
* @param argument: Not used
* @retval None
*/
...
/**
* @brief Function implementing the ReceiveT thread.
* @param argument: Not used
* @retval None
*/
